...
export default class Canvas {
  ...
  constructor(public canvasParent: HTMLDivElement) {
    ...
    this.renderer.setSize(canvasParent.offsetWidth, canvasParent.offsetHeight);
    ...
    this.outlinePass = new OutlinePass(
      new THREE.Vector2(canvasParent.offsetWidth, canvasParent.offsetHeight),
      this.scene,
      this.camera
    );
    // -- parameter config
    ...
    this.effectFXAA.uniforms["resolution"].value.set(
      1 / canvasParent.offsetWidth,
      1 / canvasParent.offsetHeight
    );
  ...
  //responsive screen
  OnWindowResize() {
    const width = this.canvasParent.offsetWidth;
    const height = this.canvasParent.offsetHeight;
    ...
    this.effectFXAA.uniforms["resolution"].value.set(
      1 / this.canvasParent.offsetWidth,
      1 / this.canvasParent.offsetHeight
    );
  }
}
